...
public class StatsMenu {
    ...
    public static void initializeStatsMenuItems(final Player player, final Inventory inventory) {
        ...
        inventory.setItem(23, GuiItem.createGuiItem(new ItemStack(Material.YELLOW_TERRACOTTA, 1), ChatColor.YELLOW + "\u27b6 Dexterité " + ChatColor.GRAY + PlayerProfile.getStat(player, PlayerProfile.Stat.DEXTIRITYNATIVE), ChatColor.GRAY + "La dexterit\u00e9 vous permet d'augmenter vos chances de coup critique physique.", "", ChatColor.GREEN + "Clic gauche + Ajouter 1 point", ChatColor.GREEN + "Clic droit + Ajouter 5 points"));
        inventory.setItem(25, GuiItem.createGuiItem(new ItemStack(Material.WHITE_TERRACOTTA, 1), ChatColor.WHITE + "\u2727 Agilité " + ChatColor.GRAY + PlayerProfile.getStat(player, PlayerProfile.Stat.AGILITYNATIVE), ChatColor.GRAY + "L'agilit\u00e9 vous permet d'augmenter vos chances d'esquives et votre vitesse de d\u00e9placement.", "", ChatColor.GREEN + "Clic gauche + Ajouter 1 point", ChatColor.GREEN + "Clic droit + Ajouter 5 points"));
